...
object Dependencies {
  ...
  lazy val CVMappingAll  = crossMapped("2.11.8" -> "2.11", "2.10.6" -> "2.10")
  lazy val CVMappingScalaz = crossMapped("2.11.8" ->"2.11", "2.10.6" -> "2.10")

  lazy val slf4jVersion = "1.7.2"

  lazy val scalazGroup        = defaultOrMapped("org.scalaz")
  lazy val scalazVersion      = defaultOrMapped("6.0.4")
  lazy val scalaz7Version     = defaultOrMapped("7.0.0",  "2.11.8" -> "7.0.6")
  lazy val specs2Version      = defaultOrMapped("1.12.3", "2.11.8" -> "2.3.11")
  lazy val scalatestVersion   = defaultOrMapped("1.9.1",  "2.11.8" -> "2.1.3")
